...
| F_03.0 | System will accept values between 1-15 to define a word by its minimum length of characters. |The professor is not interested in counting smaller words when averaging the length of a sentence. | medium
